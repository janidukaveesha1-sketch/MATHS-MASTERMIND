...
# 2. CSS, Custom Fonts & Background Video Loop Setup
st.markdown(
    """
    <style>
...
# 4. API Key Verification (Securely loaded from Secrets)
...
# 6. Styled Web App Title & Header Area
...
if st.button(btn_label):
    if not API_KEY:
        st.error("Gemini API Key එක අතුරුදහන්! Streamlit Cloud Secrets වලට GEMINI_API_KEY එකතු කරන්න.")
    elif user_text or user_image:
        with st.spinner("Analyzing and generating answer... / විසඳුම සකස් කරමින් පවතී..."):
            try:
                ...
                - Use LaTeX formatting ($...$ for inline math and $$...$$ for block math equations) for all equations, formulas, and mathematical variables.
                - If Language is 'Sinhala', use clear Sri Lankan A/L Sinhala technical terms combined with LaTeX equations.
                - If Language is 'English', use pure English explanation with LaTeX equations.
                """
